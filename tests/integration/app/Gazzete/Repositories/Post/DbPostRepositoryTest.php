...
use App\Gazette\Repositories\Post\DbPostRepository;
...
class DbPostRepositoryTest extends \TestCase
{
	...
	{
		$expectedLatestPosts = factory(App\Gazette\Models\Post::class, 2)->create();
		factory(App\Gazette\Models\Post::class)->create();
	...
	{
		$post = factory(App\Gazette\Models\Post::class)->create();
		$expectedCategory = factory(App\Gazette\Models\Category::class)->create();
	...
	{
		$post = factory(App\Gazette\Models\Post::class)->make();
